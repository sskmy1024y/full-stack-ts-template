...
import { PrismaRwClient, PrismaRwContext, PrismaTxClient, PrismaTxContext } from "./PrismaContext.js";
...
export const withTx = async <T, U>(ctx: T, f: (ctx: T & PrismaTxContext) => Promise<U>, option?: PrismaTxOption): Promise<U> =>
