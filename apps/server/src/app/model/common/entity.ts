...
export const newIdWithBrand = <T extends string>(brand: T): ID<T> => idWithBrandSchema(brand).parse(newId());

export const entitySchemaBy = <T extends string>(schema: IDSchema<T>) => z.object({ 
  id: schema,
